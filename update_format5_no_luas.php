...
echo "Updating Format 5 calculations WITHOUT using luas...\n";
...
foreach ($records as $record) {
    ...
    // Force recalculate with new formula (without luas)
...
echo "Updated {$updated} records successfully (WITHOUT luas calculation)!\n";
