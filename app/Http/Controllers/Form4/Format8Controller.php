...
use App\Http\Requests\StoreFormat8Request;
...
class Format8Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('forms.form4.format8.create', compact('bencana'));
    }

    /**
     * Store format8 form data for Education sector
     */
    public function store(StoreFormat8Request $request)
    {        
        ...
        try {
            ...
            $this->saveItem(
                $formulir->id,
                $request->pemulihan['kategori'] ?? null,
                $request->pemulihan['sub_kategori'] ?? null,
                $request->pemulihan['jumlah'] ?? null,
                $request->pemulihan['jumlah2'] ?? null,
                $request->pemulihan['harga_satuan'] ?? null,
                null,
                'unit',
                null,
                null,
            ...
            $this->saveItem(
                $formulir->id,
                $request->listrik['kategori'] ?? null,
                $request->listrik['sub_kategori'] ?? null,
                $request->listrik['jumlah'] ?? null,
                $request->listrik['jumlah2'] ?? null,
                $request->listrik['harga_satuan'] ?? null,
                null,
                $request->listrik['satuan'] ?? 'kwh',
                null,
                null,
                $request->global['durasi'] ?? null,
                $request->global['durasi_satuan'] ?? null
