...
use App\Http\Requests\StoreFormat10Request;
...
class Format10Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('forms.form4.format10.create', compact('bencana'));
    }
    ...
    /**
     * Store format10 form data for Education sector
     */
    public function store(StoreFormat10Request $request)
    {        
