...
use App\Http\Requests\StoreFormat11Request;
...
class Format11Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('forms.form4.format11.create', compact('bencana'));
    }
    ...
    /**
     * Store format11 form data for Education sector
     */
    public function store(StoreFormat11Request $request)
    {        
        ...
        try {
            ...
            // $hargaMaster = $request->harga_satuan ?? [];

            // $details = $request->details;

            // foreach ($details as $i => $detail) {

            //     $row = $detail['sub_kategori'] ?? null;

            //     // ambil angka dari "baris_1"
            //     $rowNumber = str_replace('baris_', '', $row);

            //     $details[$i]['harga_satuan'] =
            //         $hargaMaster[$rowNumber] ?? 0;
            // }
