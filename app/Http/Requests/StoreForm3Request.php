...
class StoreForm3Request extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nama_opd_3' => 'nullable|string|max:255',
            'tanggal_opd_3' => 'nullable|date',
            'nama_opd_4' => 'nullable|string|max:255',
            'tanggal_opd_4' => 'nullable|date',
            'nama_opd_5' => 'nullable|string|max:255',
            'tanggal_opd_5' => 'nullable|date',
            'nama_opd_6' => 'nullable|string|max:255',
            'tanggal_opd_6' => 'nullable|date',
