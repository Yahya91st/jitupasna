...
.has-sub.active .submenu li:nth-child(1) { transition-delay: 0.1s; }
.has-sub.active .submenu li:nth-child(2) { transition-delay: 0.15s; }
.has-sub.active .submenu li:nth-child(3) { transition-delay: 0.2s; }
.has-sub.active .submenu li:nth-child(4) { transition-delay: 0.25s; }
.has-sub.active .submenu li:nth-child(5) { transition-delay: 0.3s; }
</style>
