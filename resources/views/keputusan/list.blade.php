    ...
    <div class="page-container">
        ...
        <div class="main-card">
            ...
            @if ($keputusan)
                ...
                <a href="{{ route('keputusan.edit', $keputusan->id) }}" class="btn btn-warning">
                    Edit Keputusan
                </a>
            @else
                <form action="{{ route('keputusan.store', $laporan->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keputusan" class="form-control" rows="5" placeholder="Tuliskan keputusan pimpinan">
</textarea>
