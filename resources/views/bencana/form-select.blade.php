                            ...
                            <tbody>
                                @foreach ($bencana as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('forms.index', ['bencana_id' => $item->id]) }}" class="btn btn-primary">
                ...
                <div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            ...
                            </div>                            <form action="{{ route('bencana.index', ['source' => 'forms']) }}" method="GET" id="filterForm">
                                <input type="hidden" name="source" value="forms">
...
<script>
    function resetFilters() {
        ...
        // Make sure we maintain the source parameter when resetting filters
