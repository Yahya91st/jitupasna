...
@section('content')
    ...
    <div class="page-title mb-4">
        ...
        <p class="text-subtitle text-muted">Silahkan pilih kejadian bencana untuk melihat data kerusakan dan kerugian</p>
    </div>
</div>
...
<div class="row" id="table-striped">
                            ...
                            <tbody>
                                @foreach ($bencana as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('kebutuhan.show', $item->id) }}" class="btn btn-primary">
                                                <i class="fa fa-chart-bar mr-1"></i>
                                                Lihat Kerusakan & Kerugian
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
                ...
                <div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{ route('bencana.index', ['source' => 'kebutuhan']) }}" method="GET" id="filterForm">
                                <input type="hidden" name="source" value="kebutuhan">
    ...
    <script>
        function resetFilters() {
            document.getElementById('kategori_bencana_id').selectedIndex = 0;
