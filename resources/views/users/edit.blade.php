...
@section('content')
    <style>
        ...
        .form-control:focus {
            box-shadow: 0 0 0 0.12rem rgba(242, 135, 5, 0.12);
        ...
        <div class="col-md-8 mx-auto">
            <div class="card main-card">
                <div class="card-header card-header-gradient">
                    <h4 class="mb-0" style="color: #fff; font-weight: 700; font-size: 1.05rem;">
                        Edit User: {{ $user->name }}
                    </h4>
                    ...
                    <form action="{{ route('users.update', $user) }}" method="POST" novalidate>
                        ...
                        <div class="mb-3 position-relative">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" autocomplete="new-password" placeholder="Isi jika ingin ganti">
