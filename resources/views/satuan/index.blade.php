                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem"
                                                ...
                                                data-target="#UpdateData{{ $item->id }}" style="cursor: pointer;">
                                                <path fill="#F28705"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('satuan.update', $item->id) }}"
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button type="submit"
                                                                    class="btn mr-1 mb-1" style="background-color: #F28705; border-color: #F28705; color: white;">Submit</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('satuan.store') }}" method="POST">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn mr-1 mb-1" style="background-color: #F28705; border-color: #F28705; color: white;">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
