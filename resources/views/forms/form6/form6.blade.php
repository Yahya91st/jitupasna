...
@section('content')
<div class="container mt-4" style="font-family: Arial, sans-serif; font-size: 14px;">
    <h5 class="text-center font-weight-bold">Formulir 06<br>Pendataan Tingkat Rumahtangga</h5>
