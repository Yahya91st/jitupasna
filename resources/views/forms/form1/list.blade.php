...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold mb-6" style="color: #F28705;">Daftar Surat Permohonan Keterlibatan dalam PDNA</h1>
    ...
    <div class="mb-4 flex justify-between">
        ...
        <a href="{{ route('forms.form1.index', ['bencana_id' => $bencana->id]) }}" class="btn" style="background-color: #F28705; color: white; border: none;">
    ...
    <div class="bg-white rounded-lg shadow overflow-x-auto">
                ...
                <tr>
                    ...
                    <td>{{ $data->created_at->format('d-m-Y H:i') }}</td>                    <td>
                        <div class="btn-group" style="display: flex; gap: 2px;">
                            <form action="{{ route('forms.form1.show', $data->id) }}" method="GET" style="display: inline;">
                            ...
                            <form action="{{ route('forms.form1.edit', $data->id) }}" method="GET" style="display: inline;">
                            ...
                            <form action="{{ route('forms.form1.destroy', $data->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus surat permohonan ini?')">
                                @csrf
                                @method('DELETE')
        ...
        <div class="p-6 text-center">
            ...
            <a href="{{ route('forms.form1.index', ['bencana_id' => $bencana->id]) }}" class="btn mt-4" style="background-color: #F28705; color: white; border: none;">
