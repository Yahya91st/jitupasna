            ...
            <div class="row">
                <div class="col-md-12 mb-4">
                    <div class="alert alert-light-primary color-primary">
                        <p><strong>Bencana:</strong> {{ $penilaian->bencana->kategori_bencana->nama }}</p>
                        <p><strong>Tanggal:</strong> {{ $penilaian->bencana->tanggal }}</p>
                        <p><strong>Lokasi:</strong> 
                            @foreach($penilaian->bencana->desa as $desa)
            ...
            <div class="row mt-5">
                <div class="col-md-12">
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('forms.form8.listPenilaian', ['bencana_id' => $penilaian->bencana_id]) }}" class="btn btn-secondary">Kembali</a>                        <div>
                            <a href="{{ route('forms.form8.preview-pdf', $penilaian->id) }}" class="btn btn-secondary" target="_blank">
                                <i class="bi bi-eye"></i> Lihat PDF
                            </a>
                            <a href="{{ route('forms.form8.pdf', $penilaian->id) }}" class="btn btn-primary">
