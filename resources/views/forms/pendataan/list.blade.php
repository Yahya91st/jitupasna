            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>                        <div class="btn-group">
                            <a href="{{ route('forms.form3.show', $data->id) }}" class="btn btn-sm btn-info">
                                <i class="fa fa-eye"></i> Detail
                            </a>
                            <a href="{{ route('forms.form3.preview-pdf', $data->id) }}" class="btn btn-sm btn-secondary" target="_blank">
                                <i class="fa fa-search"></i> Lihat PDF
                            </a>
                            <a href="{{ route('forms.form3.pdf', $data->id) }}" class="btn btn-sm btn-primary" target="_blank">
