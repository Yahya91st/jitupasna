...
@section('content')
    <div class="container mx-auto px-4 py-6">
        <h1 class="text-2xl font-bold mb-6" style="color: #F28705;">Daftar Kuesioner Form 09</h1>
        ...
        <div class="mb-4 d-flex justify-content-between">
            ...
            <a href="{{ route('forms.form9.index', ['bencana_id' => request()->get('bencana_id')]) }}" class="btn" style="background-color: #F28705; color: white;">
        ...
        <div class="bg-white rounded-lg shadow overflow-x-auto">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" style="display: flex; gap: 2px;">
                                        ...
                                        <form action="{{ route('forms.form9.edit', $form->id) }}" method="GET" style="display: inline;">
                                        ...
                                        <form action="{{ route('forms.form9.destroy', $form->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                            @csrf
                                            @method('DELETE')
            ...
            @else
                <div class="p-6 text-center">
                    ...
                    <a href="{{ route('forms.form9.index', ['bencana_id' => request()->get('bencana_id')]) }}" class="btn mt-4" style="background-color: #F28705; color: white;">
