    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('forms.form2.update', $keputusan->id) }}" method="POST">
                @csrf
                @method('PATCH')
                <input type="hidden" name="bencana_id" value="{{ $keputusan->bencana_id }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nomor_surat') is-invalid @enderror" id="nomor_surat" name="nomor_surat" value="{{ old('nomor_surat', $keputusan->nomor_surat) }}" required>
                            @error('nomor_surat')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('tanggal_ditetapkan') is-invalid @enderror" id="tanggal_ditetapkan" name="tanggal_ditetapkan" value="{{ old('tanggal_ditetapkan', $keputusan->tanggal_ditetapkan) }}" required>
                ...
                <div class="row mt-3">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('tentang') is-invalid @enderror" id="tentang" name="tentang" value="{{ old('tentang', $keputusan->tentang) }}" required>
                            @error('tentang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('lokasi') is-invalid @enderror" id="lokasi" name="lokasi" value="{{ old('lokasi', $keputusan->lokasi) }}" required>
                            @error('lokasi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('pejabat_penandatangan') is-invalid @enderror" id="pejabat_penandatangan" name="pejabat_penandatangan" value="{{ old('pejabat_penandatangan', $keputusan->pejabat_penandatangan) }}" required placeholder="Deputi Rehabilitasi dan Rekonstruksi BNPB / Kepala BPBD">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('menimbang') is-invalid @enderror" id="menimbang" name="menimbang" rows="5" required>{{ old('menimbang', $menimbang) }}</textarea>
                            @error('menimbang')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('mengingat') is-invalid @enderror" id="mengingat" name="mengingat" rows="5" required>{{ old('mengingat', $mengingat) }}</textarea>
                            @error('mengingat')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('tim_kerja') is-invalid @enderror" id="tim_kerja" name="tim_kerja" rows="7" required>{{ old('tim_kerja', $keputusan->tim_kerja) }}</textarea>
                            @error('tim_kerja')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('tugas_tim') is-invalid @enderror" id="tugas_tim" name="tugas_tim" rows="7" required>{{ old('tugas_tim', $keputusan->tugas_tim) }}</textarea>
                            @error('tugas_tim')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('penanggung_jawab') is-invalid @enderror" id="penanggung_jawab" name="penanggung_jawab" value="{{ old('penanggung_jawab', $keputusan->penanggung_jawab) }}" required placeholder="Deputi Rehabilitasi dan Rekonstruksi BNPB / Kepala Daerah">
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('tembusan') is-invalid @enderror" id="tembusan" name="tembusan" rows="5" required>{{ old('tembusan', $keputusan->tembusan) }}</textarea>
                            @error('tembusan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
