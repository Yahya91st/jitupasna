    ...
    <div class="page-title mb-4">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3 style="color: #F28705;">Daftar Surat Keputusan Tim Kerja</h3>
                ...
                <div class="float-end">
                    <a href="{{ route('forms.index', ['bencana_id' => request()->get('bencana_id')]) }}" class="btn me-2" style="background-color: #6c757d; color: white; border: none;">
                        <i class="bi bi-arrow-left"></i> Kembali
                    </a>
                    <a href="{{ route('forms.form2.index') }}" class="btn" style="background-color: #F28705; color: white; border: none;">
                        ...
                        <tr>
                            ...
                            <td>                           
                                <div class="btn-group" style="display: flex; gap: 2px;">
                                    <form action="{{ route('forms.form2.show', $data->id) }}" method="GET" style="display: inline;">
                                    ...
                                    <form action="{{ route('forms.form2.edit', $data->id) }}" method="GET" style="display: inline;">
                                    ...
                                    <form action="{{ route('forms.form2.destroy', $data->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus surat keputusan ini?')">
                                        @csrf
                                        @method('DELETE')
