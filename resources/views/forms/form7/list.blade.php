                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" style="display: flex; gap: 2px;">
                                                <form action="{{ route('forms.form7.show', $form->id) }}" method="GET" style="display: inline;">
                                                ...
                                                <form action="{{ route('forms.form7.edit', $form->id) }}" method="GET" style="display: inline;">
                                                ...
                                                <form action="{{ route('forms.form7.destroy', $form->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data FGD ini?')">
                                                    @csrf
                                                    @method('DELETE')
