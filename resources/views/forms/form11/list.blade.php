...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold mb-6" style="color: #F28705;">Daftar Rekapitulasi Kebutuhan Pascabencana</h1>
    ...
    <div class="mb-4 d-flex justify-content-between">
        <a href="{{ route('forms.index', ['bencana_id' => request()->get('bencana_id')]) }}" class="btn" style="background-color: #6c757d; color: white;">
            <i class="fa fa-arrow-left"></i> Kembali
        </a>
        <a href="{{ route('forms.form11.index', ['bencana_id' => request()->get('bencana_id')]) }}" class="btn" style="background-color: #F28705; color: white;">
    ...
    <div class="bg-white rounded-lg shadow overflow-x-auto">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group" style="display: flex; gap: 2px;">
                            <form action="{{ route('forms.form11.show', $rekapitulasi->id) }}" method="GET" style="display: inline;">
                            ...
                            <form action="{{ route('forms.form11.edit', $rekapitulasi->id) }}" method="GET" style="display: inline;">
                            ...
                            <form action="{{ route('forms.form11.destroy', $rekapitulasi->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data rekapitulasi kebutuhan pascabencana ini?')">
                                @csrf
                                @method('DELETE')
        ...
        <div class="p-6 text-center">
            ...
            <a href="{{ route('forms.form11.index', ['bencana_id' => request()->get('bencana_id')]) }}" class="btn mt-4" style="background-color: #F28705; color: white;">
                <i class="fa fa-plus"></i> Tambah Data Sekarang
            </a>
        </div>
        @endif
    </div>
