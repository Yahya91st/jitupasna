            ...
            <div class="bg-white rounded-lg shadow mb-6">
                <div class="p-4 border-b">
                    ...
                    <div class="bg-blue-100 p-3 mb-4 rounded">
                        ...
                        <p>ID: {{ $lossReport->id }}</p>
                        <p>Jenis Fasilitas: {{ $lossReport->jenis_fasilitas }}</p>
                        <p>Tenaga Kerja HOK: {{ $lossReport->tenaga_kerja_hok ?? 'null' }}</p>
                        <p>Upah Harian: {{ $lossReport->upah_harian ?? 'null' }}</p>
                        <p>Alat Berat Hari: {{ $lossReport->alat_berat_hari ?? 'null' }}</p>
                        <p>Biaya per Hari Alat Berat: {{ $lossReport->biaya_per_hari_alat_berat ?? 'null' }}</p>
                        <p>Jumlah Unit: {{ $lossReport->jumlah_unit ?? 'null' }}</p>
                        <p>Biaya Sewa per Unit: {{ $lossReport->biaya_sewa_per_unit ?? 'null' }}</p>
                        <p>Jumlah Arsip: {{ $lossReport->jumlah_arsip ?? 'null' }}</p>
                        <p>Harga Satuan: {{ $lossReport->harga_satuan ?? 'null' }}</p>
                    </div>
                </div>
                ...
                <div class="p-4 border-b">
                    ...
                    <div class="overflow-x-auto">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                @php 
                                    $biayaPuing = (($lossReport->tenaga_kerja_hok ?? 0) * ($lossReport->upah_harian ?? 0)) + 
                                ...
                                <tr class="bg-gray-100 font-bold">
                                    <td colspan="4" class="text-center">SUBTOTAL BIAYA PEMBERSIHAN PUING</td>
                ...
                <div class="p-4 border-b">
                    ...
                    <div class="overflow-x-auto">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                @php
                                    $biayaKantor = ($lossReport->jumlah_unit ?? 0) * ($lossReport->biaya_sewa_per_unit ?? 0);
                                ...
                                <tr class="bg-gray-100 font-bold">
                                    <td colspan="2" class="text-center">SUBTOTAL BIAYA KANTOR SEMENTARA</td>
                ...
                <div class="p-4">
                    ...
                    <div class="overflow-x-auto">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                @php
                                    $biayaArsip = ($lossReport->jumlah_arsip ?? 0) * ($lossReport->harga_satuan ?? 0);
                                ...
                                <tr>
                                    ...
                                    <td>{{ $lossReport->dasar_perhitungan ?? '-' }}</td>
                                    <td class="text-right font-bold">{{ number_format($biayaArsip, 0, ',', '.') }}</td>
                                </tr>
                                <tr class="bg-gray-100 font-bold">
                                    <td colspan="3" class="text-center">SUBTOTAL BIAYA PENGGANTIAN ARSIP</td>
