...
<div class="container-fluid py-4">
    ...
    @endif      <div class="mb-4 d-flex justify-content-between">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('forms.form4.format9form4', ['bencana_id' => $bencana->id]) }}" class="btn btn-info">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Detail Laporan Kerusakan Sektor Telekomunikasi</h6>            <div class="btn-group">
                <a href="{{ route('forms.form4.format9.pdf', $formTelekomunikasi->id) }}" target="_blank" class="btn btn-sm btn-danger">
                    <i class="fa fa-file-pdf me-1"></i> PDF
                </a>
                <a href="{{ route('forms.form4.format9.preview-pdf', $formTelekomunikasi->id) }}" target="_blank" class="btn btn-sm btn-secondary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <h4 class="text-primary">Rp {{ number_format($formTelekomunikasi->total_kerusakan ?? 0, 0, ',', '.') }}</h4>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-1">Total Kerugian:</p>
                                    <h4 class="text-danger">Rp {{ number_format($formTelekomunikasi->total_kerugian ?? 0, 0, ',', '.') }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-end">{{ number_format(($formTelekomunikasi->kerusakan_1_jumlah_unit ?? 0) * ($formTelekomunikasi->kerusakan_1_harga_satuan ?? 0), 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td>Kantor</td>
                            ...
                            <td class="text-end">{{ number_format(($formTelekomunikasi->kerusakan_2_jumlah_unit ?? 0) * ($formTelekomunikasi->kerusakan_2_harga_satuan ?? 0), 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td>Pemancar</td>
                            ...
                            <td class="text-end">{{ number_format(($formTelekomunikasi->kerusakan_3_jumlah_unit ?? 0) * ($formTelekomunikasi->kerusakan_3_harga_satuan ?? 0), 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td>Kabel (meter)</td>
                            ...
                            <td class="text-end">{{ number_format(($formTelekomunikasi->kerusakan_4_jumlah_unit ?? 0) * ($formTelekomunikasi->kerusakan_4_harga_satuan ?? 0), 0, ',', '.') }}</td>
                        </tr>
                        <tr>
                            <td>Server</td>
                            ...
                            <td class="text-end">{{ number_format(($formTelekomunikasi->jangka_waktu_unit ?? 0) * ($formTelekomunikasi->jangka_waktu_harga_satuan ?? 0), 0, ',', '.') }}</td>
                        </tr>
                    ...
                    <tfoot class="bg-light font-weight-bold">
                        <tr>
                            ...
                            <td class="text-end">{{ number_format($formTelekomunikasi->total_kerusakan ?? 0, 0, ',', '.') }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">{{ number_format(($formTelekomunikasi->biaya_operasional_pasca_unit ?? 0) * ($formTelekomunikasi->biaya_operasional_pasca_harga_satuan ?? 0), 0, ',', '.') }}</td>
                        </tr>
                    </tbody>
                    <tfoot class="bg-light font-weight-bold">
                        <tr>
                            <td colspan="2" class="text-end">Total Biaya Pembersihan & Darurat</td>
                            <td class="text-end">{{ number_format(($formTelekomunikasi->kenaikan_biaya_operasional_unit ?? 0) * ($formTelekomunikasi->kenaikan_biaya_operasional_harga_satuan ?? 0), 0, ',', '.') }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-end">{{ number_format(($formTelekomunikasi->penurunan_pendapatan_unit ?? 0) * ($formTelekomunikasi->penurunan_pendapatan_harga_satuan ?? 0), 0, ',', '.') }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>            
                        ...
                        <div class="col-md-4">
                            <div class="card bg-light">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class="text-primary">Rp {{ number_format($formTelekomunikasi->total_kerusakan ?? 0, 0, ',', '.') }}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card bg-light">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class="text-danger">Rp {{ number_format($formTelekomunikasi->total_kerugian ?? 0, 0, ',', '.') }}</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card bg-light">
                                <div class="card-body text-center">
                                    ...
                                    <h3 class="text-success">Rp {{ number_format(($formTelekomunikasi->total_kerusakan ?? 0) + ($formTelekomunikasi->total_kerugian ?? 0), 0, ',', '.') }}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
