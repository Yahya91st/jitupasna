...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-2xl font-bold mb-6">Data Format 3 - Sektor Kesehatan</h1>
    ...
    <div class="mb-4 flex justify-between">
        ...
        </a>        <a href="{{ route('forms.form4.format3form4', ['bencana_id' => $bencana->id]) }}" class="btn btn-primary">
    ...
    @else
        <div class="bg-white p-8 rounded-lg shadow text-center">
            ...
            <p class="text-gray-600 mb-4">Belum ada data laporan kesehatan untuk bencana ini.</p>
            <a href="#" class="btn btn-primary" onclick="alert('Form input Format 3 belum tersedia')">
