        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Daftar Laporan Format 6 - Sarana Air Minum & Sanitasi</h3>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Daftar Laporan Sarana Air Minum & Sanitasi</h4>
                ...
                <div class="card-body">
                    @if ($reports->isEmpty())
                        <div class="alert alert-info">
                            Belum ada data laporan sarana air minum & sanitasi untuk bencana ini.
                        </div>
                    @else
                                ...
                                <tbody>
                                    @foreach ($reports as $index => $report)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('forms.form4.format6.show', $report->id) }}" class="btn btn-sm btn-info"><i class="bi bi-eye"></i> Lihat</a>
                                                <a href="{{ route('forms.form4.format6.edit', $report->id) }}" class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i> Edit</a>
                                                <form action="{{ route('forms.form4.format6.destroy', $report->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                                    @csrf
                                                    @method('DELETE')
