                        ...
                        <tbody>
                            @forelse($forms as $index => $form)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('forms.form4.format8.show', $form->id) }}" class="btn btn-sm btn-info">
                                            <i class="bi bi-eye"></i> Detail
                                        </a>
                                        <a href="{{ route('forms.form4.format8.pdf', $form->id) }}" target="_blank" class="btn btn-sm btn-danger">
