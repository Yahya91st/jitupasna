                            ...
                            <tr>
                                ...
                                <td style="width:35%">
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" name="details[{{ $detailIndex }}][kategori]" value="{{ $item['jumlah_name'] }}">

                                        <input type="hidden" name="details[{{ $detailIndex }}][sub_kategori]" value="jumlah">

                                        <input type="hidden" name="details[{{ $detailIndex }}][satuan]" value="{{ $item['jumlah_suffix'] }}">
                                    </div>
                                </td>
