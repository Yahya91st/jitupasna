        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h1 class="card-title">Formulir Verifikasi Lapangan Sektor Infrastruktur (Jalan)</h1>
                </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td class="parent-input-1">
                                            ...
                                            <select id="jenis_asset" name="jenis_asset" class="form-control style-input-1 d-inline">
                                                ...
                                                <option value="Jalan Propinsi">Jalan Propinsi</option>
                                                <option value="Jalan Kab/Kota">Jalan Kab/Kota</option>
                                    ...
                                    <tr>
                                        <td class="parent-input-1">
                                            ...
                                            <input type="text" id="nama_jalan" name="nama_jalan" class="form-control style-input-1 d-inline">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="parent-input-1">
                                            <label for="lapisan_perkerasan">Lapisan Perkerasan)**</label>
                                            <select name="lapisan_perkerasan" id="lapisan_perkerasan" class="form-control style-input-1 d-inline">
                                                <option value="">Pilih Lapisan Perkerasan</option>
                                                <option value="Flexible pavement (perkerasan lentur)">Flexible pavement (perkerasan lentur)</option>
                                                <option value="Rigid Pavement (perkerasan kaku)">Rigid Pavement (perkerasan kaku)</option>
                                                <option value="Composit pavement (perkerasan komposit)">Composit pavement (perkerasan komposit)</option>
                                    ...
                                    <tr>
                                        <td class="parent-input-1">
                                            ...
                                            <input type="number" id="lebar_jalan" name="lebar_jalan" class="form-control style-input-1 d-inline">
                                    ...
                                    <tr>
                                        <td class="parent-input-1">
                                            ...
                                            <input type="number" id="panjang_jalan" name="panjang_jalan" class="form-control style-input-1 d-inline">
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <p>                                            
                                                Data Kerusakan Spot 1, Panjang : <input type="number" id="panjang_spot1" name="panjang_spot1" class="form-control style-input-1 d-inline" style="width: 80px;"> M/KM*
                                            </p>                                            
                                        </td>
                                        <td>
                                            Bobot (%)
                                    ...
                                    <tr>
                                        ...
                                        <td class="radio-inline" colspan="3">
                                            ...
                                            <label for="badan_jalan_1">
                                                Terjadi keretakan meluas dan atau berlubang pada lapisan atas masih dapat dilalui kendaraan roda dua dan roda empat tanpa melalui rekayasa lalu lintas
                                            </label>
                                        </td>
                                        <td>
                                            <input type="radio" id="badan_jalan_1_bobot" name="jenis_kerusakan_badan_jalan_bobot" value="25" class="d-inline">
                                            <label for="badan_jalan_1_bobot">25</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="radio-inline" colspan="3">
                                            ...
                                            <label for="badan_jalan_2">
                                                Terjadi keretakan meluas dan atau berlubang pada lapisan atas, masih dapat dilalui kendaraan roda dua dan roda empat melalui rekayasa lalu lintas
                                            </label>                                            
                                        </td>
                                        <td>
                                            <input type="radio" id="badan_jalan_2_bobot" name="jenis_kerusakan_badan_jalan_bobot" value="50" class="d-inline">
                                            <label for="badan_jalan_2_bobot">50</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="radio-inline" colspan="3">
                                            <input type="radio" id="badan_jalan_3" name="jenis_kerusakan_badan_jalan" value="badan_jalan_3" class="d-inline">
                                            <label for="badan_jalan_3">
                                                Terjadi keretakan meluas dan atau berlubang yang mencapai lapisan dasar; tidak dapat dilalui kendaraan roda dua dan roda empat
                                            </label>                                            
                                        </td>
                                        <td>
                                            <input type="radio" id="badan_jalan_3_bobot" name="jenis_kerusakan_badan_jalan_bobot" value="70" class="d-inline">
                                            <label for="badan_jalan_3_bobot">70</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td rowspan="2">
                                        ...
                                        <td colspan="3" class="radio-inline">
                                            ...
                                            <label for="bahu_jalan_1">
                                                Elevasi permukaan bahu jalan lebih tinggi atau rendah 5-10 CM dengan permukaan jalan; bahu jalan masih berfungsi
                                            </label>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td colspan="3" class="radio-inline">
                                            ...
                                            <label for="bahu_jalan_2">
                                                Elevasi permukaan bahu jalan lebih tinggi atau rendah lebih dari 10 CM dengan permukaan jalan atau bahun jalan hilang; bahu jalan tidak berfungsi
                                            </label>
                                        </td>
                                        <td>
                                            <input type="radio" id="bahu_jalan_2_bobot" name="bahu_jalan_bobot" value="15" class="d-inline">
                                            <label for="bahu_jalan_2_bobot">15</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td rowspan="3">
                                        ...
                                        <td colspan="3" class="radio-inline">
                                            ...
                                            <label for="drainase_1">Terdapat kerusakan kecil struktur; terjadi keretakan namun tidak menembus tanah pada dinding dan atau dasar saluran; saluran masih berfungsi dan atau bisa diperbaiki                                            </label>
                                        </td>
                                        <td>
                                            <input type="radio" id="drainase_1_bobot" name="drainase_bobot" value="5" class="d-inline">
                                            <label for="drainase_1_bobot">5</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="radio-inline">
                                            ...
                                            <label for="drainase_2">
                                                Terdapat kerusakan sebagian struktur; terjadi keretakan sampai menembus tanah pada dinding dan atau dasar saluran; saluran masih berfungsi dan atau bisa diperbaiki
                                            </label>
                                        </td>
                                        <td>
                                            <input type="radio" id="drainase_2_bobot" name="drainase_bobot" value="50" class="d-inline">
                                            <label for="drainase_2_bobot">10</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" class="radio-inline">
                                            <input  type="radio" id="drainase_3" name="drainase" value="drainase_3" class="d-inline">
                                            <label for="drainase_3">
                                                Terdapat kerusakan keseluruhan struktur; dinding roboh dan atau dasar saluran pecah; saluran tidak berfungsi dan atau tidak bisa diperbaiki
                                            </label>
                                        </td>
                                        <td>
                                            <input type="radio" id="drainase_3_bobot" name="drainase_bobot" value="100" class="d-inline">
                                            <label for="drainase_3_bobot">15</label>
                                        </td>
                                    </tr>                                    
                                </table>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            <div>
                                                Jumlah Kapal/Perahu)*
                                                <input type="number" name="jumlah_kapal" class="form-control d-inline-block" style="width:120px;display:inline-block;" min="0">
                                                Unit
                                            </div>
                                            <div>
                                                pendapatan rata-rata Rp
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div>
                                                Hilang atau terganggunya akses individu, keluarga dan masyarakat terhadap pemenuhan kebutuhan dasarnya akibat suatu bencana:
                                            </div>
                                            <textarea name="gangguan_akses" id="gangguan_akses" class="form-control"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <textarea name="gangguan_fungsi" id="gangguan_fungsi" class="form-control"></textarea>
                                        </td>
                                    </tr>                                    
                                    <tr>
                                        <td>
                                            ...
                                            <div>
                                                Meningkatnya kerentanan dan atau menurunnya kapasitas individu dan keluarga sebagai akibat dari suatu bencana:
                                            </div>
                                            <textarea name="meningkatnya_resiko" id="meningkatnya_resiko" class="form-control"></textarea>
                                        </td>
                                    </tr>
                                </table>
                                <div align="right">
