                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="bencana-info">
                                            <img class="bencana-img" src="{{ asset('/frontend/dist/assets/images/avatar/' . $item['gambar']) }}" alt="{{ $item->kategori_bencana->nama }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-select" name="kategori_bencana_id" id="kategori_bencana_id">
                                    ...
                                    @foreach ($kategoribencana as $item)
                                        <option value="{{ $item->id }}" {{ request()->input('kategori_bencana_id') == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama }}
                                        </option>
                                    @endforeach
                                </select>
